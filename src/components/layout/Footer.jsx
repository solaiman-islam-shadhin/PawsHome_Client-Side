      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Connecting loving families with pets in need. Every adoption saves a life and creates a forever bond.
            </p>
            <div className="flex items-center space-x-2 text-gray-300">
              <Heart size={16} className="text-red-500" />
              <span className="text-sm">Made with love for our furry friends</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">info@pawshome.com</span>
              </li>
              <li className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 PawsHome. All rights reserved.
          </p>
